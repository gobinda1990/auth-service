...
//    }
//
//    private String generateToken(CustomUserDetails userDetails, long expirationMillis) {
...
//        claims.put("circleCd", userDetails.getCircleCode());
//        claims.put("chargeCd", userDetails.getChargeCode());
...
//            // treat invalid tokens as 'not expired' here for clearer semantics to caller
//            return false;
//        }
//    }
//
